...
namespace farmtrax {
    namespace turners {
        ...
        struct ReedsSheppSegment {
            ...
            inline ReedsSheppSegment(ReedsSheppSegmentType t, double l, bool fwd = true)
        ...
        class ReedsSheppStateSpace {
          public:
            ...
            static inline const ReedsSheppPathSegmentType reedsSheppPathType[18][5] = {
            ...
            class ReedsSheppPath {
              public:
                inline ReedsSheppPath(const ReedsSheppPathSegmentType *type = reedsSheppPathType[0],
            ...
            inline double distance(double q0[3], double q1[3]) const { return reedsShepp(q0, q1).length(); }
