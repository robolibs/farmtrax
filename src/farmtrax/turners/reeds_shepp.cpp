...
namespace farmtrax {
    namespace turners {
        ...
        ReedsSheppSegment::ReedsSheppSegment(ReedsSheppSegmentType t, double l, bool fwd)
            : type(t), length(l), forward(fwd) {}

        ReedsSheppPath::ReedsSheppPath() : total_length(0.0) {}

        double ReedsSheppStateSpace::ReedsSheppPath::length() const { return totalLength_; }

        ReedsSheppStateSpace::ReedsSheppStateSpace(double turningRadius) : rho_(turningRadius) {}
        ...
        double ReedsSheppStateSpace::distance(double q0[3], double q1[3]) const { return reedsShepp(q0, q1).length(); }

        std::vector<ReedsSheppStateSpace::ReedsSheppPathSegmentType> ReedsSheppStateSpace::type(double q0[3],
                                                                                                double q1[3]) const {
        ...
        void ReedsSheppStateSpace::sample(double q0[3], double q1[3], double step_size, double &length,
        ...
        ReedsShepp::ReedsShepp(double min_turning_radius) : Dubins(min_turning_radius), rs_(min_turning_radius) {}

        std::string ReedsShepp::getPathName(const ReedsSheppStateSpace::ReedsSheppPath &path) const {
            std::string name;
            for (int i = 0; i < 5; ++i) {
                ...
                case ReedsSheppStateSpace::RS_LEFT:
                    name += (path.length_[i] >= 0) ? "L" : "l";
                    break;
                case ReedsSheppStateSpace::RS_RIGHT:
                    name += (path.length_[i] >= 0) ? "R" : "r";
                    break;
                case ReedsSheppStateSpace::RS_STRAIGHT:
                    name += (path.length_[i] >= 0) ? "S" : "s";
                    break;
