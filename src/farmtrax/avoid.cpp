...
namespace farmtrax {
    ...
    // Constructor with BPolygon obstacles
    ObstacleAvoider::ObstacleAvoider(const std::vector<BPolygon> &obstacles, const concord::Datum &datum)
        : obstacles_(obstacles), inflation_distance_(0.0f), datum_(datum) {}

    // Constructor with concord::Polygon obstacles
    ObstacleAvoider::ObstacleAvoider(const std::vector<concord::Polygon> &obstacles, const concord::Datum &datum)
        : datum_(datum) {
    ...
    std::vector<std::shared_ptr<Swath>>
    ObstacleAvoider::avoid(const std::vector<std::shared_ptr<const Swath>> &input_swaths, float inflation_distance) {
    ...
    std::vector<std::shared_ptr<Swath>> ObstacleAvoider::avoid(const std::vector<std::shared_ptr<Swath>> &input_swaths,
    ...
    const std::vector<BPolygon> &ObstacleAvoider::get_obstacles() const { return obstacles_; }

    // Get inflated obstacles
    const std::vector<BPolygon> &ObstacleAvoider::get_inflated_obstacles() const { return inflated_obstacles_; }

    void ObstacleAvoider::inflate_obstacles() {
    ...
    BPolygon ObstacleAvoider::inflate_polygon(const BPolygon &polygon, float distance) const {
    ...
    std::vector<std::shared_ptr<Swath>> ObstacleAvoider::process_swath(const std::shared_ptr<const Swath> &swath) {
    ...
    std::vector<std::shared_ptr<Swath>>
    ObstacleAvoider::cut_swath_around_obstacles(const std::shared_ptr<const Swath> &swath) {
        std::vector<std::shared_ptr<Swath>> result;
